...
// 课堂基本信息及其子课程
export async function fetchClassRoomInfo(params) {
  return request.get(`${BaseUrl}/classroom/Class/getDetailByClassId`, {
    params
  });
}
...
//   课程查看
export async function classCourseInfoDetialById(params) {
  return request.get(`${BaseUrl}/classroom/ClassCourse/getDetail`, {
    params
  });
}
...
//   课程审核
export async function ClassCourseCheck(data) {
  return request.post(`${BaseUrl}/classroom/ClassCourse/check`, {
    data,
  });
}
